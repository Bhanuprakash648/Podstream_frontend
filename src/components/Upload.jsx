import {
    BackupRounded, CloseRounded, CloudDoneRounded
...
const Upload = ({ setUploadOpen }) => {
    ...
    const uploadFile = (file, index) => {
        ...
        formData.append("upload_preset", "ctyimhdv");
        axios.post(
            `https://api.cloudinary.com/v1_1/djbbzzavw/video/upload`, 
            formData, 
            {
        ...
        .then((response) => {
            ...
            newEpisodes[index].file = response.data.secure_url;
    ...
    useEffect(() => {
        if (podcast.episodes.length > 0 && podcast.episodes.every(episode => episode.file !== "" && episode.name !== "" && episode.desc !== "" && podcast.name !== "" && podcast.desc !== "" && podcast.tags.length > 0 && podcast.thumbnail !== "")) {
                                                ...
                                                {typeof podcast.episodes[index].file === 'string' ? (
                                                    ...
                                                    <>
                                                        ...
                                                        <LinearProgress
                                                            ...
                                                            color={"success"}
                                                        />
                                                        {podcast.episodes[index].file.uploadProgress || 0}% Uploaded
                                                    </>
                                                )}
                                            </Uploading>
                                        )}
